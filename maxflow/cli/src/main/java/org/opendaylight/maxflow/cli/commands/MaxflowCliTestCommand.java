 ...
 */
package org.opendaylight.maxflow.cli.commands;
...
public class MaxflowCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(MaxflowCliTestCommand.class);
    protected final MaxflowCliCommands service;

    public MaxflowCliTestCommand(final MaxflowCliCommands service) {
